...
def open_application(command):
    if "notepad" in command:
        ...
        try:
            subprocess.Popen("C:\\Users\\yaswa\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe")
            return "VS Code opened."
        except FileNotFoundError:
            return "VS Code not found. Please ensure it is installed and added to PATH."
